...
describe('plaintextToQasm', () => {
  ...
  describe('edge cases - timing and spacing', () => {
    ...
    it('handles multiple hyphens as timing markers', () => {
      expect(plaintextToQasm('H--X', false)).toEqual(
        'OPENQASM 2.0;\n' +
          'include "qelib1.inc";\n' +
          'qreg q[1];\n' +
  ...
  describe('special cases that should work', () => {
    it('handles 10-qubit circuit', () => {
      ...
      const result = plaintextToQasm(tenQubits, false);
    ...
    it('handles very long gate sequence', () => {
      ...
      const result = plaintextToQasm(longSequence, false);
  ...
  describe('pattern recognition', () => {
    ...
    it('identifies swap pattern using CNOTs', () => {
      const swap = plaintextToQasm('X#1-I-X#1\nI---X#0-I', false);
  ...
  describe('complex edge cases', () => {
    it('handles circuit from example file with complex control structure', () => {
      const input =
        'I---Z#1-I-H-I-X#2-I---I-H\n' +
        'H#0-I---I-H-I-I---X#2-I-H\n' +
        'I---Z#0-I-X-H-X#1-X#0-H-X\n' +
        'I---I---I-I-I-I---I---I-I';
  ...
  describe('special characters handling', () => {
    it('handles circuit ending with special character from example', () => {
      expect(plaintextToQasm('I-I-I---I-I<', false)).toEqual(
        'OPENQASM 2.0;\n' +
          'include "qelib1.inc";\n' +
          'qreg q[1];\n' +
          '// Unknown symbol: <\n',
